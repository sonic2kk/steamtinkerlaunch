...
*(Some features (f.e. [ReShade](https://github.com/podiki/steamtinkerlaunch/wiki/ReShade)) are only available for games using proton)*
*(Non-Steam games added to Steam are supported as well)*

There are two ways to use **stl** with steam.
Either as [Launch Option](#Steam-Launch-Option) or as [Steam Compatibility Tool](https://github.com/podiki/steamtinkerlaunch/wiki/Steam-Compatibility-Tool)
...
If within a short waiting period *(default 2 seconds)* the spacebar is pressed the [Settings Menu](https://github.com/podiki/steamtinkerlaunch/wiki/Settings-Menu) will open where everything can be configured comfortably.
...
Almost everything can be configured with the built-in [Settings Menu](https://github.com/podiki/steamtinkerlaunch/wiki/Settings-Menu), but optionally also with a graphical text editor.
It might be a good idea to start with configuring everything in the [Settings Menu](https://github.com/podiki/steamtinkerlaunch/wiki/Settings-Menu) to your needs
...
- xrandr
- xwininfo
- [Yad](https://github.com/v1cont/yad) All GUI elements like [Settings Menu](https://github.com/podiki/steamtinkerlaunch/wiki/Settings-Menu), [Tray Icon](https://github.com/podiki/steamtinkerlaunch/wiki/Tray-Icon), the [Editor Dialog](https://github.com/podiki/steamtinkerlaunch/wiki/Settings-Menu#editor-dialog)
...
- [strace](https://github.com/podiki/steamtinkerlaunch/wiki/Strace)
- [Gamemode](https://github.com/podiki/steamtinkerlaunch/wiki/GameMode)
- [MangoHud](https://github.com/podiki/steamtinkerlaunch/wiki/MangoHud)
- [winetricks](https://github.com/podiki/steamtinkerlaunch/wiki/Winetricks)
- vr-video-player for playing regular games side-by-side in VR ([SBS-VR](https://github.com/podiki/steamtinkerlaunch/wiki/Side-by-Side-VR))
- a graphical text editor and optionally an internet browser see [Global Config](https://github.com/podiki/steamtinkerlaunch/wiki/Configuration-Locations#global-config)
- [vkBasalt](https://github.com/podiki/steamtinkerlaunch/wiki/vkBasalt)
- [Nyrna](https://github.com/podiki/steamtinkerlaunch/wiki/Nyrna)
- [ReplaySorcery](https://github.com/podiki/steamtinkerlaunch/wiki/ReplaySorcery)
- netstat from net-tools for basic network monitoring
- [Boxtron](https://github.com/podiki/steamtinkerlaunch/wiki/Boxtron) and dosbox to optionally start dos games with linux native dosbox
...
- [GameConqueror/scanmem](https://github.com/podiki/steamtinkerlaunch/wiki/GameConqueror) to optionally cheat
- [GameScope](https://github.com/podiki/steamtinkerlaunch/wiki/GameScope)
- cabextract *(currently only used to extract the [WMP10](https://github.com/podiki/steamtinkerlaunch/wiki/WMP10) setup exe)*
- innoextract *(currently only used to extract the [Cheat Engine](https://github.com/podiki/steamtinkerlaunch/wiki/Cheat-Engine) setup exe - with wine as fallback)*
- lsusb *(for an optional [SBS-VR](https://github.com/podiki/steamtinkerlaunch/wiki/Side-by-Side-VR) check if a VR HMD was found)*
...
- openssl *(currently only used to generate a random hex string for [Non-Steam Game](https://github.com/podiki/steamtinkerlaunch/wiki/Add-Non-Steam-Game) `appid`)*

## Configuration
All configuration files are self-contained documented and always growing, so not every option is documented in here.
For a general overview what can be configured, just check the [wiki](https://github.com/podiki/steamtinkerlaunch/wiki) or simply browse through the 
[Settings Menu](https://github.com/podiki/steamtinkerlaunch/wiki/Settings-Menu), which covers almost everything available.

### Wait requester
The initial Requester which acts as gate to the [Settings Menu](https://github.com/podiki/steamtinkerlaunch/wiki/Settings-Menu).
...
When `WAITEDITOR` is set to 0 *(in [Game Menu](https://github.com/podiki/steamtinkerlaunch/wiki/Settings-Menu#game-menu))* **stl** will directly start the game with the current configuration.
If `MAXASK` in the [Global Config](https://github.com/podiki/steamtinkerlaunch/wiki/Configuration-Locations#global-config) *(f.e. via [Global Menu](https://github.com/podiki/steamtinkerlaunch/wiki/))* is defined, the requester can be cancelled maximal `MAXASK` times
...
The "Cancelled counter" is stored directly in the [Game Config](https://github.com/podiki/steamtinkerlaunch/wiki/Configuration-Locations#game-config) as `ASKCNT`
...
Can for example be configured in the [GUI Options](https://github.com/podiki/steamtinkerlaunch/wiki/Settings-Menu#GUI-Options)
Options are
- [Selection Menu](https://github.com/podiki/steamtinkerlaunch/wiki/Settings-Menu#Selection-Menu) *(default)*
- [Favorites Menu](https://github.com/podiki/steamtinkerlaunch/wiki/Settings-Menu#Favorites-Menu)
- [Game Menu](https://github.com/podiki/steamtinkerlaunch/wiki/Settings-Menu#Game-Menu)
- [Editor Dialog](https://github.com/podiki/steamtinkerlaunch/wiki/Settings-Menu#Editor-Dialog)

### [Configuration Locations](https://github.com/podiki/steamtinkerlaunch/wiki/Configuration-Locations)
...
### Logs
Logs are written into the `LOGDIR` defined in the [Global Menu](https://github.com/podiki/steamtinkerlaunch/wiki/Settings-Menu#global-menu) / [Global Config](https://github.com/podiki/steamtinkerlaunch/wiki/Configuration-Locations#global-config).

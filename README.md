...
| Manual Installation | SteamTinkerLaunch supports **system-wide** (root) and may support a **local** (non-root) manual installation. [See Installation Wiki notes](https://github.com/frostworx/steamtinkerlaunch/wiki/Installation#manual-installation) for setup and details. |

...
That means, if you're developing a feature for SteamTinkerLaunch v15.2 on on August 14th 2025, you would set the string as `v15.2.20250414-1`. If this date was already used, you would change the `-1` to be `-2` in this case, or `-3` and so on.

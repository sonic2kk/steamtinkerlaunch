...
**SteamTinkerLaunch** (сокращенно **stl**) это утилита для Linux, используемая в дополнение к клиенту Steam, позволяющая на лету конфигурировать настройки для запуска игр и приложений *(Смотри [Фишки](#Features))*

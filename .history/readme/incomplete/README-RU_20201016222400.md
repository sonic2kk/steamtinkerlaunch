...
Может быть отключена *(включена по умолчанию)* переключением параметра `USETRAYICON` в [Меню настроек](#Settings-Menu) Global Config Tab or [global.conf](#Global-Config).

...
Может быть отключена *(включена по умолчанию)* переключением параметра `USETRAYICON` в [Settings Menu](#Settings-Menu) Global Config Tab or [global.conf](#Global-Config).

...
Если в качестве параметра `USEGUI` вы выбрали "zenity", [Диалог редактирования](#Editor-Dialog) will open instead of the [Settings Menu](#Settings-Menu), but the parameters are the same.

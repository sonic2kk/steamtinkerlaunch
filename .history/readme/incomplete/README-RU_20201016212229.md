...
Если в качестве параметра `USEGUI` вы выбрали "zenity", the [Editor Dialog](#Editor-Dialog) will open instead of the [Settings Menu](#Settings-Menu), but the parameters are the same.

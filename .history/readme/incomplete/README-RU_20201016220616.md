...
В качестве опциональных аргументов коммандной строки могут выступать SteamAppID or `last` for opening the config of the last played game stored in `LASTRUN`

...
- xrandr
- xwininfo
- [Yad](https://github.com/v1cont/yad). *(используется по умолчанию)* - [Меню Настроек](#меню-настроек) и [иконки в трее](#Иконка-в-трее-Icon) работают только при использовании yad.

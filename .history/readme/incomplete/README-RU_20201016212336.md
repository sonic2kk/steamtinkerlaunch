...
Если в качестве параметра `USEGUI` вы выбрали "zenity", [Диалог редактирования](#Editor-Dialog) будет вызван без запуска [Меню настроек](#Settings-Menu), but the parameters are the same.
